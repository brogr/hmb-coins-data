...
var LC = /*@__PURE__*/getDefaultExportFromCjs(localeData);
...
const P = new WeakMap();
const U$1 = new WeakMap();
const A$1 = new WeakMap();
const X$1 = new WeakMap();

const PM = [Bitmask.YMD, Bitmask.Y, Bitmask.YM, Bitmask.YMD];

let Date$1 = class Date extends globalThis.Date {
  ...
  set unspecified(value) {
    X$1.set(this, new Bitmask(value));
  }
...
class Decade extends ExtDateTime {
  ...
  set decade(decade) {
    ...
    assert(abs$1(decade) < 1000, `invalid decade: ${decade}`);
