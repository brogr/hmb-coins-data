...
async function generateManifests() {
	try {
		...
		const MANIFEST_BASE_PATH = `${GITHUB_BASE_URL}/iiif/traces/manifests`;

		// Fix the audio URL to use media.githubusercontent.com instead of raw.githubusercontent.com
		const AUDIO_BASE_URL =
			"https://media.githubusercontent.com/media/brogr/hmb-coins-data/refs/heads/main/iiif/traces/audio";
